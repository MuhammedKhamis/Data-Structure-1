...
public interface IHangman {
   ...
   * 
   * @param c1
   *          case insensitive user guess. If c is NULL then ignore it and do no change.
   * @return secret word with hidden characters (use '-' instead unsolved characters), or return
   *         NULL if user reached max wrong guesses.
   */
  String guess(Character c1);
